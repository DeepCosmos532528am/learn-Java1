package com.mycompony.src;//CBSE Board Percentage calculator
/*why sometimes the hovering donot happen in my LOQ lenovo ,
 ...
 askbar nothing hover happened no response of maximixing on cli
 cking happening, on taking the cursor to the close icon on the intelli j as opened
  at that time the mark getting red , no response on clicking , i
            ...
            do {
                ...
                if (password.equals("no")) {
                    ...
                    switch (password2) {
                        ...
                        default ->
                                System.out.println(" It seems your input is mistaken! please Try Again with correct input ");
                    }
                }
            } while (!password2.equals("rain") && !password2.equals("no"));
